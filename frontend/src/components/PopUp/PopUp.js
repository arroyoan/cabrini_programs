  ...
  return (
    <>
      <div className={styles.popup__card}>
        ...
        <h3 className={styles.popup__location} onClick={()=>onClick(properties.id)}>{properties.locationName}{/*<Link to={`/locations/${properties.id}`}>{properties.locationName}</Link>*/}</h3>
