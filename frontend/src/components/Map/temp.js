...
const Map = ({history,locations}) => {
  ...
  // // should rerender the map if locations change
  // useEffect(() => {
  ...
  //   console.log('CHECKING THE IF FOR LOCATIONS');
  //   console.log(map.current.getLayer('locations') !== undefined);
  //   if(map.current.getLayer('locations') !== undefined)
  ...
  // const removeMarkers=()=>{
  //   console.log('ENTERED REMOVE MARKERS');
  //   for(let i =0;i<currentMarkers.length;++i)
  //     currentMarkers[i].remove()

  //   const divs = document.querySelectorAll('[id=mapMarker]')
  //   console.log(divs);
  //   divs.forEach(el=>el.remove())
  //   console.log(document.querySelectorAll('[id=mapMarker]'));

  //   console.log('LEAVING REMOBE MARKERS');
  // }
